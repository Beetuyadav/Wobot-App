...
export default class DetailScreen extends React.Component {
  ...
  componentWillMount = async () => {
    ...
    const jobname=await AsyncStorage.getItem('jobname')
     ...
     console.warn('Image:---',image_url);
     console.warn('Video:---',video_url);
  ...
  render() {
    ...
    return (
      // console.log('MyVideo__',video_url);
      <View style={styles.container}>
        <View style={{ marginHorizontal: 10, marginVertical: 5 }}>
          ...
          <Image
              style={{with:'100%',height:120,marginTop:5,}}
              source={{uri: image_url}}
            />
        <Text style={styles.subheader}>Video: </Text>
           <View style={{with:'100%',height:100,marginTop:5,backgroundColor:'red'}}>
        <WebView
